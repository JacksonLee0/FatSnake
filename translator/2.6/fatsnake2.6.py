...
def getLongTranslationYoudao(content):
    timestamp = time.time()
    # 生成salt
...
def versionInfo(event):
    ...
    ========================================\n
    """
    wx.MessageBox(text, 'Fat Snake Translator --version 2.6', wx.OK | wx.ICON_NONE)
...
class Window(wx.Frame):
    def __init__(self, parent, title):
        ...
        self.sourceLanguage = wx.ComboBox(self.panel, pos=(171, 77), size=(110, 30), value=sourceList[0],
                                          choices=sourceList,
        ...
        self.nameLabel_1 = wx.StaticText(self.panel, pos=(9, 30), label='============================'
                                                                        '=============== 谷歌翻译 ==============='
                                                                        '============================')
        ...
        '''YOUDAO EN TO CN'''
        self.nameLabel_2 = wx.StaticText(self.panel, pos=(9, 30), label='============================'
                                                                        '=============== 有道翻译 ==============='
                                                                        '============================')
        self.nameLabel_2.SetFont(self.font4tfoot)

        self.foot = wx.StaticText(self.panel, label='========================================  FAT SNAKE  2.6  '
                                                    '========================================', pos=(9, 365))
